...
hi EnumerationValue guifg=#ffffff guibg=#181615 guisp=#181615 gui=none ctermfg=0 ctermbg=234 cterm=bold
hi EnumerationName guifg=#ffffff guibg=#181615 guisp=#181615 gui=none ctermfg=0 ctermbg=234 cterm=bold
hi CTagsGlobalVariable guifg=#ffffff guibg=#181615 guisp=#181615 gui=none ctermfg=0 ctermbg=234 cterm=bold
hi DefinedName guifg=#ffffff guibg=#181615 guisp=#181615 gui=NONE ctermfg=0 ctermbg=234 cterm=bold
hi LocalVariable guifg=#ffffff guibg=#181615 guisp=#181615 gui=NONE ctermfg=0 ctermbg=234 cterm=bold

"hi CTagsClass -- no settings --
"hi clear -- no settings --

"その他
hi Normal guifg=#ffffff guibg=#181615 guisp=#181615 gui=NONE ctermfg=51 ctermbg=NONE cterm=NONE
...
"起動時のAA
hi Title guifg=#a58aff guibg=NONE guisp=#2b262b gui=bold ctermfg=141 ctermbg=NONE cterm=bold
...
"変数の宣言
hi Identifier guifg=#96f3fa guibg=NONE guisp=#000000 gui=NONE ctermfg=199 ctermbg=NONE cterm=NONE

hi SpecialChar guifg=#c051d3 guibg=NONE guisp=NONE gui=NONE ctermfg=11 ctermbg=NONE cterm=NONE
hi Conditional guifg=#db93c8 guibg=NONE guisp=NONE gui=bold ctermfg=175 ctermbg=NONE cterm=bold

"変数
hi StorageClass guifg=#536991 guibg=NONE guisp=NONE gui=bold ctermfg=90 ctermbg=NONE cterm=NONE
...
hi Delimiter guifg=#67fffa guibg=NONE guisp=NONE gui=bold ctermfg=51 ctermbg=NONE cterm=bold
...
"コメント
hi Comment guifg=#9c38bd guibg=NONE guisp=NONE gui=NONE ctermfg=67 ctermbg=NONE cterm=NONE
...
"数値
hi Number guifg=#ff00bb guibg=NONE guisp=NONE gui=NONE ctermfg=198 ctermbg=NONE cterm=NONE
"真偽値
hi Boolean guifg=#A1A6A8 guibg=NONE guisp=NONE gui=NONE ctermfg=165 ctermbg=NONE cterm=NONE
...
"関数
hi Keyword guifg=#0098a3 guibg=NONE guisp=NONE gui=bold ctermfg=208 ctermbg=NONE cterm=bold

"HTMLの属性,型
hi Type guifg=#536991 guibg=NONE guisp=NONE gui=bold ctermfg=50 ctermbg=NONE cterm=bold
...
""文字列型
hi String guifg=#dd00ff guibg=NONE guisp=#000000 gui=NONE ctermfg=85 ctermbg=NONE cterm=NONE 

hi PMenuThumb guifg=#00858f guibg=#00f7ff guisp=#00f7ff gui=NONE ctermfg=30 ctermbg=51 cterm=NONE
hi MatchParen guifg=#dd00ff guibg=NONE guisp=#000000 gui=bold ctermfg=0 ctermbg=51 cterm=NONE
...
"NERDTreeのファイル
hi Directory guifg=#00ff7f guibg=NONE guisp=NONE gui=bold ctermfg=44 ctermbg=NONE cterm=bold

"console.log()のconsoleのとこ
hi Structure guifg=#536991 guibg=NONE guisp=NONE gui=bold ctermfg=51 ctermbg=NONE cterm=NONE
