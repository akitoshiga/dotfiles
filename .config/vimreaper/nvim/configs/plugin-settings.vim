...
let g:startify_custom_header = s:center(s:header2)
...
hi EasyMotionShade  guibg=none guifg=cyan
hi EasyMotionTarget2First guibg=none guifg=red
hi EasyMotionTarget2Second guibg=none guifg=cyan
